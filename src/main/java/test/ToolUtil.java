...
public class ToolUtil {
    ...
    public static void main(String[] args) {
        System.out.println(ToolUtil.aesEncrypt("622424199809075678"));
        System.out.println(ToolUtil.aesDecrypt("EE6A69211A169C64B9B69FB0CDCBFD722D9F9744D2198DA3F1F362C45DEA8F51"));
